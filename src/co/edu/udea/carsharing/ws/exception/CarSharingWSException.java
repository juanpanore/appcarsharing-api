package co.edu.udea.carsharing.ws.exception;
 ...
 */
public class CarSharingWSException extends Exception {
	...
	private static final Logger LOGGER = Logger
			.getLogger(CarSharingWSException.class);

	/**
	 * Constante utilizada para realizar operaciones de serializaci&oacute;n y
	 * deserializaci&oacute;n de la instancia {@code CarSharingWSException}, e
	 ...
	 * aplicaci&oacute;n.
	 */
	public CarSharingWSException() {
		super();
		LOGGER.error("CarSharingWSException: An error has happened during process.");
	}
	 ...
	 */
	public CarSharingWSException(String message) {
		super(message);
		LOGGER.error("CarSharingWSException: An error has happened during process."
				+ message);
	}
	 ...
	 *            ser lanzado.
	 */
	public CarSharingWSException(Throwable cause) {
		super(cause);
		LOGGER.error(
				"CarSharingWSException: An error has happened during process.",
				cause);
	}
	 ...
	 *            ser lanzado.
	 */
	public CarSharingWSException(String message, Throwable cause) {
		super(message, cause);
		LOGGER.error(
				"CarSharingWSException: An error has happened during process.",
				cause);
