package co.edu.udea.carsharing.persistence.exception;
 ...
 */
public class CarSharingPersistenceBusinessException extends Exception {
	...
	private static final Logger LOGGER = Logger
			.getLogger(CarSharingPersistenceBusinessException.class);

	/**
	 * Constante utilizada para realizar operaciones de serializaci&oacute;n y
	 * deserializaci&oacute;n de la instancia
	 * {@code CarSharingPersistenceBusinessException}, e igualmente, de todos
	 * los atributos esta instancia agrupe.
	 */
	 ...
	 * aplicaci&oacute;n.
	 */
	public CarSharingPersistenceBusinessException() {
		super();
		LOGGER.error("CarSharingPersistenceBusinessException: An error has happened during process.");
	}
	 ...
	 */
	public CarSharingPersistenceBusinessException(String message) {
		super(message);
		LOGGER.error("CarSharingPersistenceBusinessException: An error has happened during process."
				+ message);
	}
	 ...
	 *            ser lanzado.
	 */
	public CarSharingPersistenceBusinessException(Throwable cause) {
		super(cause);
		LOGGER.error(
				"CarSharingPersistenceBusinessException: An error has happened during process.",
				cause);
	}
